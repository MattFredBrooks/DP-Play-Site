...
$(function(){
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=1200){var e=document.querySelector('.js7');e.setAttribute('src',(dpi>1)?'images/clipboardclip-1120.png':'images/clipboardclip-560.png');}else{var e=document.querySelector('.js7');e.setAttribute('src',(dpi>1)?'images/clipboardclip-896.png':'images/clipboardclip-448.png');}}};
if(!window.HTMLPictureElement){$(window).resize(r);r();}
js8=new Plyr('.js8 video',{iconUrl:'css/plyr.svg',blankUrl: 'css/blank.mp4',controls:['play','progress','current-time','mute','volume','fullscreen'],storage:{enabled:false}});
js8.volume=0.8;
